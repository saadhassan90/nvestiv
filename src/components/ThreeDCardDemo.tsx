            ...
            <div className="space-y-3">
              ...
              <div className="bg-gray-50/30 dark:bg-gray-900/30 border border-gray-300/30 dark:border-gray-600/30 rounded-md p-3 sm:p-4 overflow-hidden">
                <div className="flex flex-col items-center text-center space-y-2 sm:flex-row sm:justify-between sm:text-left sm:items-start sm:space-y-0 gap-2 sm:gap-4">
                  ...
                  <Badge variant="outline" className="text-xs font-normal text-green-700 border-green-300 flex-shrink-0 mx-auto sm:mx-0">
                    ✓ Complete
                  </Badge>
                </div>
              </div>
                  ...
                  <div className="flex flex-col items-center text-center space-y-2 sm:flex-row sm:justify-between sm:text-left sm:items-start sm:space-y-0 gap-2 sm:gap-4">
                    <div className="flex-1 min-w-0 w-full">
                      <div className="flex items-center justify-center gap-2 mb-2 sm:justify-start">
                        ...
                        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 break-words text-center sm:text-left">Detected body text + 1 attachments</h3>
                      </div>
                      <div className="flex flex-col items-center space-y-1 sm:flex-row sm:space-y-0 gap-2 sm:gap-4 w-full">
                        <p className="text-xs text-gray-500 dark:text-gray-400 break-words text-center sm:text-left">Email summary generated. Parsed .pdf file</p>
                  ...
                  <div className="flex flex-col items-center text-center space-y-2 sm:flex-row sm:justify-between sm:text-left sm:items-start sm:space-y-0 gap-2 sm:gap-4">
                    <div className="flex-1 min-w-0 w-full">
                      <div className="flex items-center justify-center gap-2 mb-2 sm:justify-start">
                        ...
                        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 break-words text-center sm:text-left">New Contact & Company Created</h3>
                      </div>
                      <div className="flex flex-col items-center space-y-1 sm:flex-row sm:space-y-0 gap-2 sm:gap-4 w-full">
                        <p className="text-xs text-gray-500 dark:text-gray-400 break-words text-center sm:text-left">Terraview and Jordan Noah did not already exist.</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400 break-words text-center sm:text-left">Updated contact using email details.</p>
                      </div>
                    </div>
                    <Badge variant="outline" className="text-xs font-normal text-green-700 border-green-300 flex-shrink-0 mx-auto sm:mx-0">
                      ✓ Complete
                  ...
                  <div className="flex flex-col items-center text-center space-y-2 sm:flex-row sm:justify-between sm:text-left sm:items-start sm:space-y-0 gap-2 sm:gap-4">
                    <div className="flex-1 min-w-0 w-full">
                      <div className="flex items-center justify-center gap-2 mb-2 sm:justify-start">
                        ...
                        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 break-words text-center sm:text-left">Sending email introduction</h3>
                      </div>
                      <div className="flex flex-col items-center space-y-1 sm:flex-row sm:space-y-0 gap-2 sm:gap-4 w-full">
                    ...
                    <Badge variant="outline" className="text-xs font-normal text-blue-700 border-blue-300 flex-shrink-0 mx-auto sm:mx-0">
