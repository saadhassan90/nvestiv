  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-screen-xl mx-auto">
        {/* Hero Section */}
        <section className="h-[calc(100vh-8rem)] flex items-center justify-center px-6 relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-700 to-slate-600 rounded-3xl mx-4 my-4">
