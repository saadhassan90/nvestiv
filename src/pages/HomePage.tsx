...
const HomePage = () => {
  ...
  return <div className="min-h-screen bg-background relative">
      ...
      <main className="pt-24 md:pt-28 lg:pt-32 relative z-10 bg-white">
        <div className="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f0a_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f0a_1px,transparent_1px)] bg-[size:60px_60px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)]"></div>
