...
const HomePage = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <main className="max-w-screen-xl mx-auto">
        {/* Hero Section */}
        <section className="h-[calc(100vh-8rem)] flex items-center justify-center px-6 relative overflow-hidden rounded-3xl mx-4 my-4" style={{ background: 'radial-gradient(ellipse at center, #0f172a 0%, #1e293b 35%, #334155 55%, #475569 75%, #64748b 85%, #2563eb 100%)' }}>
